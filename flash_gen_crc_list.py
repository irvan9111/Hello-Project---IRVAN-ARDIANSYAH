...
sparse_file_list = {
	"system":"system.img",
	"cust":"cust.img", #just for miui
	"userdata":"userdata.img",
	"persist":"persist.img",#just for factory software
	"vendor":"vendor.img",
}
...
unsparse_file_list = {
		...
		"recovery":"recovery.img",
       	"fsg":"fs_image.tar.gz.mbn.img", #Just for  factory software
		"fsgbak":"fs_image.tar.gz.mbn.img", #Just for  factory software
		"sec":"sec.elf", #Just for factory software
}
